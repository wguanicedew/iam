...
public class IamAccountServiceTestSupport {
  ...
  public IamAccountServiceTestSupport() {
    ...
    TEST_X509_CERTIFICATE_1 =
        new IamX509Certificate(TEST_X509_CERTIFICATE_VALUE_1);
    
    TEST_X509_CERTIFICATE_1.setCertificateSubject(TEST_X509_CERTIFICATE_SUBJECT_1);
    TEST_X509_CERTIFICATE_1.setLabel(TEST_X509_CERTIFICATE_LABEL_1);
    
    TEST_X509_CERTIFICATE_2 =
        new IamX509Certificate(TEST_X509_CERTIFICATE_VALUE_2);
    
    TEST_X509_CERTIFICATE_2.setCertificateSubject(TEST_X509_CERTIFICATE_SUBJECT_2);
