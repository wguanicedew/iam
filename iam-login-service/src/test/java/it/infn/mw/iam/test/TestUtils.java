...
public class TestUtils {
  ...
  public static String getX509TestCertificate(int index) {

    switch (index) {
      case 1:
        return "MIIDnjCCAoagAwIBAgIBCTANBgkqhkiG9w0BAQUFADAtMQswCQYDVQQGEwJJVDE"
  ...
  public static String getX509TestCertificate() {
    ...
    return getX509TestCertificate(0);
  }
