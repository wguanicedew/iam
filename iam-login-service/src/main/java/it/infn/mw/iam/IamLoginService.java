...
@ComponentScan(
    basePackages = {"it.infn.mw.iam.config", "it.infn.mw.iam.authn.saml", "it.infn.mw.iam.persistence",
        "it.infn.mw.iam.authn.oidc", "it.infn.mw.iam.core.web", "it.infn.mw.iam.api",
