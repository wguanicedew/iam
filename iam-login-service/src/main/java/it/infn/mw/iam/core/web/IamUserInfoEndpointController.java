...
public class IamUserInfoEndpointController {

  private final UserInfoService userInfoService;

  private final ClientDetailsEntityService clientService;

  private static final Logger LOG = LoggerFactory.getLogger(IamUserInfoEndpointController.class);

  @Autowired
  public IamUserInfoEndpointController(UserInfoService uis, ClientDetailsEntityService cdes) {
    this.userInfoService = uis;
    this.clientService = cdes;
  }
  ...
  public String getInfo(
    ...
    ClientDetailsEntity client =
        clientService.loadClientByClientId(auth.getOAuth2Request().getClientId());
