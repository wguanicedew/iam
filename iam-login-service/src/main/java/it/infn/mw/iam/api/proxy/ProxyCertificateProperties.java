...
public class ProxyCertificateProperties {
  ...
  private long maxLifetimeInSeconds = TimeUnit.HOURS.toSeconds(12);

  public long getMaxLifetimeInSeconds() {
    return maxLifetimeInSeconds;
  }

  public void setMaxLifetimeInSeconds(long maxLifetimeInSeconds) {
