...
public class Replacers extends BuilderSupport {
  ...
  public Updater givenName(String givenName) {
    ...
    return new DefaultUpdater<String>(ACCOUNT_REPLACE_GIVEN_NAME, ui::getGivenName,
        ui::setGivenName, givenName);
  }

  public Updater familyName(String familyName) {
    final IamUserInfo ui = account.getUserInfo();
    return new DefaultUpdater<String>(ACCOUNT_REPLACE_FAMILY_NAME, ui::getFamilyName,
  ...
  public Updater picture(String newPicture) {
    ...
    final IamUserInfo ui = account.getUserInfo();
    return new DefaultUpdater<String>(ACCOUNT_REPLACE_PICTURE, ui::getPicture, ui::setPicture,
        newPicture);
  ...
  public Updater email(String email) {
    ...
    return new DefaultUpdater<String>(ACCOUNT_REPLACE_EMAIL, ui::setEmail, email, emailAddChecks);
  }

  public Updater password(String newPassword) {

    return new DefaultUpdater<String>(ACCOUNT_REPLACE_PASSWORD, encodedPasswordSetter, newPassword,
        encodedPasswordChecker);
  }

  public Updater username(String newUsername) {

    return new DefaultUpdater<String>(ACCOUNT_REPLACE_USERNAME, account::setUsername, newUsername,
        usernameAddChecks);
  }

  public Updater active(boolean isActive) {

    return new DefaultUpdater<Boolean>(UpdaterType.ACCOUNT_REPLACE_ACTIVE, account::isActive,
