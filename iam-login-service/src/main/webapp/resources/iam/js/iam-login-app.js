...
angular.module('iam-login-app', ['ui.bootstrap'])
  .controller('idp-selection',['$scope', '$http', '$uibModalInstance','$log', '$window',
    function($scope, $http, $uibModalInstance, $log, $window) {
      ...
      $scope.lookupIdp = function(val) {
		...
		.controller('idp-selection-modal-ctrl',['$scope', '$uibModal',
