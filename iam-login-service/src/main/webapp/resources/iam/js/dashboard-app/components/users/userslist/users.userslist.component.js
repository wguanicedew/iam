  ...
  function UsersListController($q, $scope, $rootScope, $uibModal, ModalService,
    ...
    self.openDeleteUserDialog = function (user) {
      ...
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/users/userslist/user.delete.dialog.html',
    ...
    self.openAddNewUserDialog = function () {
      ...
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/users/userslist/user.add.dialog.html',
  ...
  angular
    ...
    .component(
      'userslist',
      {
        ...
        templateUrl: '/resources/iam/js/dashboard-app/components/users/userslist/users.userslist.component.html',
