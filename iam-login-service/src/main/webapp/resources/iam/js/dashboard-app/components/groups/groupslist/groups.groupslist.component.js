...
(function () {
  ...
  function GroupsListController($q, $scope, $rootScope, $uibModal, $uibModalStack, ModalService,
    ...
    self.$onInit = function () {
      console.debug("init GroupsListController", self.tokens, self.currentPage, self.currentOffset, self.totalResults);
    ...
    self.openAddParentGroupDialog = function () {
      ...
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/groups/groupslist/group.add.dialog.html',
    ...
    self.openAddSubgroupDialog = function (group) {
      ...
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/groups/groupslist/subgroup.add.dialog.html',
    ...
    self.openDeleteGroupDialog = function (group) {
      ...
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/groups/groupslist/group.delete.dialog.html',
