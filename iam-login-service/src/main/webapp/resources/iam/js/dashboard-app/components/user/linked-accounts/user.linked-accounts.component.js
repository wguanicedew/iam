...
(function() {
    ...
    function UserLinkedAccountsController($uibModal, toaster, AccountLinkingService) {
        ...
        self.openLinkExternalAccountDialog = function() {
            var modalInstance = $uibModal.open({
                templateUrl: '/resources/iam/js/dashboard-app/components/user/linked-accounts/account.link.dialog.html',
        ...
        self.openRemoveOidcAccountDialog = function(oidcId) {
            ...
            var modalInstance = $uibModal.open({
                templateUrl: '/resources/iam/js/dashboard-app/components/user/linked-accounts/oidc-id.remove.dialog.html',
        ...
        self.openUnlinkOidcAccountDialog = function(oidcId) {
            ...
            var modalInstance = $uibModal.open({
                templateUrl: '/resources/iam/js/dashboard-app/components/user/linked-accounts/oidc-id.unlink.dialog.html',
        ...
        self.openUnlinkSamlAccountDialog = function(samlId) {
            var modalInstance = $uibModal.open({
                templateUrl: '/resources/iam/js/dashboard-app/components/user/linked-accounts/saml-id.unlink.dialog.html',
        ...
        self.openRemoveSamlAccountDialog = function(samlId) {
            var modalInstance = $uibModal.open({
                templateUrl: '/resources/iam/js/dashboard-app/components/user/linked-accounts/saml-id.remove.dialog.html',
    ...
    angular.module('dashboardApp').component('userLinkedAccounts', {
        ...
        templateUrl: '/resources/iam/js/dashboard-app/components/user/linked-accounts/user.linked-accounts.component.html',
        controller: [
