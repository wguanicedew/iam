...
(function () {
  ...
  function UserSamlController(toaster, $uibModal, ModalService, scimFactory) {
    ...
    self.openAddSamlAccountDialog = function () {
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/user/saml/saml-id.add.dialog.html',
    ...
    self.openRemoveSamlAccountDialog = function (samlId) {
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/user/saml/saml-id.remove.dialog.html',
    ...
    self.openUnlinkSamlAccountDialog = function (samlId) {
      var modalInstance = $uibModal.open({
        templateUrl: '/resources/iam/js/dashboard-app/components/user/saml/saml-id.unlink.dialog.html',
        controller: LinkSamlController,
        controllerAs: '$ctrl',
        resolve: {
          action: function () {
  ...
  angular.module('dashboardApp').component('userSaml', {
    ...
    templateUrl: '/resources/iam/js/dashboard-app/components/user/saml/user.saml.component.html',
    controller: [
