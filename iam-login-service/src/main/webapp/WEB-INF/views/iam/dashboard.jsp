...
--%>
            ...
            <%@ taglib prefix="o" tagdir="/WEB-INF/tags"%>
                <%@ taglib prefix="spring" uri="http://www.springframework.org/tags"%>
                    ...
                    <body id="body" class="skin-blue" ng-app="dashboardApp" ng-cloak style="display: none">
                        ...
                        <div class="wrapper">
                            <toaster-container toaster-options="{'close-button': true, 'time-out':{ 'toast-error': 5000, 'toast-success': 5000, 'toast-warning': 5000 }, 'position-class': 'toast-top-center'}">
                            </toaster-container>
  ...
  -->
                        ...
                        <!-- Tokens component -->
                        <script type="text/javascript" src="/resources/iam/js/dashboard-app/components/tokens/refreshlist/tokens.refreshlist.component.js"></script>
                        <script type="text/javascript" src="/resources/iam/js/dashboard-app/components/tokens/accesslist/tokens.accesslist.component.js"></script>
