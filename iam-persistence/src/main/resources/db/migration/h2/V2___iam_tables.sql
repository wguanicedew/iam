...
CREATE TABLE iam_group (ID BIGINT IDENTITY NOT NULL, DESCRIPTION VARCHAR(512), NAME VARCHAR(255) NOT NULL UNIQUE, UUID VARCHAR(36) NOT NULL UNIQUE, CREATIONTIME TIMESTAMP NOT NULL, LASTUPDATETIME TIMESTAMP NOT NULL, PRIMARY KEY (ID));
