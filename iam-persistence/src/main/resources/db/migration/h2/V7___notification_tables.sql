CREATE TABLE iam_email_notification (ID BIGINT IDENTITY NOT NULL, UUID VARCHAR(36) NOT NULL UNIQUE, NOTIFICATION_TYPE VARCHAR(128) NOT NULL, SUBJECT VARCHAR(128), BODY CLOB, CREATION_TIME TIMESTAMP NOT NULL, DELIVERY_STATUS VARCHAR(128), LAST_UPDATE TIMESTAMP, PRIMARY KEY (ID));
