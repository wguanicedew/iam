...
CREATE TABLE iam_account (ID BIGINT NOT NULL, PASSWORD VARCHAR(128), USERNAME VARCHAR(128) NOT NULL UNIQUE, UUID VARCHAR(36) NOT NULL UNIQUE, SAMLACCOUNT_ID BIGINT, iam_user_info_id BIGINT, OIDC_ACCOUNT_ID BIGINT, PRIMARY KEY (ID))
...
CREATE TABLE oidc_account (ID BIGINT NOT NULL, ISSUER VARCHAR(256) NOT NULL, SUBJECT VARCHAR(256) NOT NULL, PRIMARY KEY (ID))
