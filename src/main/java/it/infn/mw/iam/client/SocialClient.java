...
@EnableOAuth2Client
@Order(110)
public class SocialClient extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    ...
    // @formatter:off
    http.antMatcher("/social_login**")
    .authorizeRequests()
        .antMatchers("/", "/social_login**").permitAll()
  ...
  public Filter ssoGitHubFilter() {
    ...
    return ssoFilter(github(), "/social_login");
  }
